...
type InstallSnapshotRequest struct {
	...
	// 空なら構成情報なし（旧形式）。
	Members       []byte `protobuf:"bytes,6,opt,name=members,proto3" json:"members,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InstallSnapshotRequest) GetMembers() []byte {
	if x != nil {
		return x.Members
	}
	return nil
...
const file_raft_proto_rawDesc = "" +
	...
	"\acommand\x18\x03 \x01(\fR\acommand\x12\x12\n" +
	"\x04type\x18\x04 \x01(\rR\x04type\"\xb0\x01\n" +
	...
	"\amembers\x18\x06 \x01(\fR\amembers\"-\n" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB'Z%github.com/noda/linkraft/proto/raftpbb\x06proto3"
